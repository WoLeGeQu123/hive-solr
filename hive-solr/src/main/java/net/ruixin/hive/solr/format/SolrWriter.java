...
public class SolrWriter implements RecordWriter {
	...
	public SolrWriter(String url, boolean isCloud,String collection, int numOutputBufferRows) {
		this.table = new SolrTable(url,isCloud,collection);
	...
	public void write(Writable w) throws IOException {
		...
		for (final Map.Entry<Writable, Writable> entry : map.entrySet()) {
			...
			Object value = getObjectFromWritable(entry.getValue());
