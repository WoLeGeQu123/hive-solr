...
public class SolrReader implements RecordReader<LongWritable, MapWritable> {
        ...
        public SolrReader(String url,boolean isCloud,String collection, SolrSplit split, String[] readColumns, int numInputBufferRows) throws IOException {
            this.split = split;
            this.numBufferRows = numInputBufferRows;

            this.readColumns = readColumns;
            SolrTable table = new SolrTable(url,isCloud,collection);
